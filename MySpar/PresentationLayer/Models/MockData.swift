...
struct MockData{
    ...
    private let stories: ListSection = {
        .stories(["stories_icon1", "stories_icon2", "stories_icon3", "stories_icon4",
                  "stories_icon5", "stories_icon6", "stories_icon7"])
    }()
    ...
    var pageData: [ListSection]{
        [stories, promotions, selection, recommend, sweetmood]
    }
}
